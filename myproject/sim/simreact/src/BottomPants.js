      ...
      <main>
        ...
        <div className="topnav">
          ...
          <ul className="navsmall">
            <li className="small-item"><Link to="/BottomPants"><p className={styles.item1}>pants</p></Link></li>
            {/* styles.item1 요소를 확인하고 싶다면 TopShirts.module.css 파일로 */}
            <li className="small-item"><Link to="/BottomSkirts"><p className="small-item2">skirts</p></Link></li>
          </ul>
        </div>
        <hr />
        <div id="ClothesPage">
