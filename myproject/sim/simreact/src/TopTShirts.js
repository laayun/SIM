      ...
      <main>
        ...
        <div className="topnav">
          ...
          <ul className="navsmall">
            <li className="small-item"><Link to="/TopShirts"><p className="small-item1">shirts</p></Link></li>
            <li className="small-item"><Link to="/TopTShirts"><p className= {styles.item2}>T-shirts</p></Link></li>
            {/* styles.item2 요소를 확인하고 싶다면 TopShirts.module.css 파일로 */}
            <li className="small-item"><Link to="/TopBlouse"><p className="small-item3">blouse</p></Link></li>
          </ul>
        </div>
        <hr />
        <div id="ClothesPage">
